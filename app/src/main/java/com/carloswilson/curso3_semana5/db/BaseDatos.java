            ...
            while (registrosLikeMayor.moveToNext()) {
                ...
                while (registros.moveToNext()) {
                    ...
                    if (registrosLikes != null && registrosLikes.moveToFirst()) {
                        ...
                        mascotaActual.setNumLinkes(likes);
                    }
        ...
        if (registros.getCount()>=1) {
            ...
            while (registros.moveToNext()) {
                ...
                if (registrosLikes.moveToNext()) {
                    mascotaActual.setNumLinkes(registrosLikes.getInt(0));
                } else {
                    mascotaActual.setNumLinkes(0);
                }
                mascotas.add(mascotaActual);
            }
            ...
            contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_FOTO, R.drawable.perro00);
            insertarMascota(contentValues);

            contentValues = new ContentValues();
            contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_NOMBRE, "Jassmine");
            contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_FOTO, R.drawable.perro01);
            insertarMascota(contentValues);

            contentValues = new ContentValues();
            contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_NOMBRE, "Ralph");
            contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_FOTO, R.drawable.perro02);
            insertarMascota(contentValues);

            contentValues = new ContentValues();
            contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_NOMBRE, "Winkle");
            contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_FOTO, R.drawable.perro03);
            insertarMascota(contentValues);

            contentValues = new ContentValues();
            contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_NOMBRE, "Terry");
            contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_FOTO, R.drawable.perro04);
            insertarMascota(contentValues);

            contentValues = new ContentValues();
            contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_NOMBRE, "Mary");
            contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_FOTO, R.drawable.perro05);
            insertarMascota(contentValues);

            contentValues = new ContentValues();
            contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_NOMBRE, "Ramon");
            contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_FOTO, R.drawable.perro06);
            insertarMascota(contentValues);

            contentValues = new ContentValues();
            contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_NOMBRE, "Blinky");
            contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_FOTO, R.drawable.perro07);
            insertarMascota(contentValues);

            contentValues = new ContentValues();
            contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_NOMBRE, "Sissy");
            contentValues.put(ConstantesBaseDatos.TABLE_MASCOTA_FOTO, R.drawable.perro08);
            insertarMascota(contentValues);
